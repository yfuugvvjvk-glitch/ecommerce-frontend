  ...
  return (
    <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-md mx-auto">
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <h3 className="text-sm font-semibold text-blue-900 mb-2">👤 Cont Vizitator (Guest)</h3>
        <div className="space-y-1 text-sm text-blue-800">
          <p><span className="font-medium">Email:</span> guest@example.com</p>
          <p><span className="font-medium">Parolă:</span> guest123</p>
        </div>
        <p className="mt-2 text-xs text-blue-600">
          Folosește acest cont pentru a testa aplicația fără a crea un cont nou.
        </p>
      </div>
    </div>
  );
